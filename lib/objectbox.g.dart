...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
    ...
    name: 'Attachment',
    lastPropertyId: const obx_int.IdUid(20, 3667295101907908955),
    flags: 0,
    properties: <obx_int.ModelProperty>[
      ...
      obx_int.ModelProperty(
        id: const obx_int.IdUid(20, 3667295101907908955),
        name: 'metadata',
        type: 13,
        flags: 0,
      ),
  ...
  obx_int.ModelEntity(
    ...
    name: 'Message',
    lastPropertyId: const obx_int.IdUid(51, 7894979336289459407),
    flags: 0,
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
      ...
      obx_int.ModelProperty(
        id: const obx_int.IdUid(51, 7894979336289459407),
        name: 'metadata',
        type: 13,
        flags: 0,
      ),
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    Attachment: obx_int.EntityDefinition<Attachment>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final metadataParam = obx_int.flexBufferToMap(buffer, rootOffset, 42);
    ...
    Message: obx_int.EntityDefinition<Message>(
      ...
      objectToFB: (Message object, fb.Builder fbb) {
        ...
        fbb.addOffset(50, metadataOffset);
        fbb.finish(fbb.endTable());
        return object.id ?? 0;
      },
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final dateDeletedParam = dateDeletedValue == null
            ? null
            : DateTime.fromMillisecondsSinceEpoch(dateDeletedValue);
        final metadataParam = obx_int.flexBufferToMap(buffer, rootOffset, 104);
